...
function Huda() {
    ...
    const getData = async ()=>{
        try {
            let res = await axios__WEBPACK_IMPORTED_MODULE_3__["default"].get("https://json-live-j5qk.onrender.com/huda");
            setPost(res.data);
        } catch (err) {
            console.log(err);
        }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default().memo(Huda));
...
var __webpack_exports__ = (__webpack_exec__(7638));
