...
function Makeup() {
    ...
    const getData = async ()=>{
        try {
            setLoad(true);
            let res = await axios__WEBPACK_IMPORTED_MODULE_3__["default"].get("https://json-live-j5qk.onrender.com/makeup");
            setPost(res.data);
            setLoad(false);
        } catch (err) {
            console.log(err);
        ...
        children: [
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((next_head__WEBPACK_IMPORTED_MODULE_4___default()), {
                children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("title", {
                    children: "Nikka Official / Makeup"
                })
            }),
            load ? /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_chakra_ui_react__WEBPACK_IMPORTED_MODULE_2__.Box, {
                m: "auto",
                mt: {
                    base: "1px",
                    lg: "-30px"
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default().memo(Makeup));
...
var __webpack_exports__ = (__webpack_exec__(9837));
